...
public class LoginLogoutControllerTest extends NinjaTest {
    ...
    public void testLogingLogout() {
        ...
        // /////////////////////////////////////////////////////////////////////
        // Test posting of quip does not work without login
        // /////////////////////////////////////////////////////////////////////
...
//        assertTrue(response.contains("Error. Forbidden."));
        ...
        // /////////////////////////////////////////////////////////////////////
        // Test posting of quip works when are logged in
        // /////////////////////////////////////////////////////////////////////
        response = ninjaTestBrowser.makeRequest(getServerAddress()
                + "quip/new", headers);
        
        assertTrue(response.contains("New quip"));
        ...
        // /////////////////////////////////////////////////////////////////////
        // Assert that posting of quip does not work any more...
        // /////////////////////////////////////////////////////////////////////
        response = ninjaTestBrowser.makeRequest(getServerAddress()
                + "quip/new", headers);
        System.out.println(response);
